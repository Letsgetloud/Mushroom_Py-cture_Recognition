...
from model.model_colab import Classifier, EnsembleClassifier, DFLT_MODEL_PATH
...
mushroomDetector = Classifier(
   ...
   #, filepath = "Is_mushroom_ENetB0.h5"
)
...
ensembleClassifier = EnsembleClassifier(
   ...
   #, filepath = "ensemble_model_sans_VGG.sav"
   ,  members = [
            efficientNetB0
         ,  efficientNetB1
         ,  efficientNetB2
